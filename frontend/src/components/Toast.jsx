    ...
    <ToastContext.Provider value={{ showToast, showSuccessToast, showErrorToast, showWarningToast, showInfoToast }}>
      ...
      <div className="fixed top-4 right-4 z-50 space-y-3">
        {toasts.map(toast => (
          <div
            key={toast.id}
            className={`flex items-center gap-3 px-4 py-3 rounded-xl shadow-2xl text-white font-medium transition-all duration-300 hover:scale-105 hover:shadow-3xl animate-slide-in backdrop-blur-sm min-w-[280px] max-w-md ${
